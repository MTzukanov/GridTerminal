...
public class MyPumpStreamHandler implements ExecuteStreamHandler {
     ...
     */
    public MyPumpStreamHandler(final OutputStream outAndErr) {
     ...
     */
    public MyPumpStreamHandler(final OutputStream out, final OutputStream err) {
        this(out, err, null);
    }
    ...
    protected Thread createPump(final InputStream is, final OutputStream os,
        ...
        final Thread result = new Thread(new MyStreamPumper(is, os,
                closeWhenExhausted));
